...
public class Generador {
    ...
    public Generador() throws ParserConfigurationException{
     ...
     public void generarDocument() {
        Element personas = document.createElement("personas"); // Creamos el elemento personas
        document.appendChild(personas); // Lo convertimos en elemento raíz

        Element persona = document.createElement("persona"); // Etiqueta persona
